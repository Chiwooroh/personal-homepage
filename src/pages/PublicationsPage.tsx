...
// Highlight "Roh, C." in neon across author strings
    ...
    <div className="bg-background text-cream min-h-screen overflow-x-hidden">
      ...
      <section className="px-6 lg:px-16 pt-20 pb-16 lg:pt-28 lg:pb-24 max-w-content mx-auto">
        ...
        <h1 className="font-grotesk text-cream leading-[0.85]">
          <span className="block text-[clamp(4rem,10vw,9rem)]">PUBLI</span>
          <span className="block text-[clamp(4rem,10vw,9rem)] text-cream/30">CATIONS</span>
        </h1>
        ...
        <div>
          ...
          <div className="flex flex-col">
            {JOURNALS.map((pub, i) => (
              <div
                key={i}
                className="flex flex-col sm:flex-row gap-4 sm:gap-10 py-8 border-b border-white/[0.06] hover:border-white/20 transition-colors group"
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="font-mono text-neon/60 text-sm tracking-wide italic">
                    {pub.venue}
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-5">
            {PATENTS.map((patent, i) => (
              <div key={i} className="liquid-glass rounded-2xl p-7">
                <p className="font-grotesk text-cream text-base lg:text-xl leading-tight mb-4">
                  {patent.title}
                </p>
