    ...
    <div className="bg-background text-cream min-h-screen overflow-x-hidden">
      ...
      <section className="px-6 lg:px-16 pt-20 pb-16 lg:pt-28 lg:pb-24 max-w-content mx-auto">
        ...
        <h1 className="font-grotesk text-cream leading-[0.85]">
          <span className="block text-[clamp(4rem,10vw,9rem)]">ABOUT</span>
          <span className="block text-[clamp(4rem,10vw,9rem)] text-cream/30">CHIWOO</span>
        </h1>
      </section>
      ...
      <div className="max-w-content mx-auto px-6 lg:px-16 pb-32 space-y-20">
        ...
        <div className="liquid-glass rounded-2xl p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
              ...
              <p className="font-mono text-cream/75 text-base lg:text-lg leading-relaxed uppercase">
                RESEARCHER AT KOREA TRANSPORT INSTITUTE
                WORKING AT THE INTERSECTION OF LARGE
                LANGUAGE MODELS, GENERATIVE AI, AND
                TRANSPORTATION SYSTEMS.
                <br /><br />
                MY WORK FOCUSES ON MAKING MOBILITY DATA
                SMARTER — FROM SYNTHESIZING INDIVIDUAL
                TRAVEL PATTERNS TO MODELING HOW PEOPLE
                BEHAVE BEHIND THE WHEEL.
              </p>
            </div>
            <div className="space-y-5">
              {[
                { label: 'Current Position', value: 'Researcher, Korea Transport Institute' },
                { label: 'Education', value: 'M.S. Transportation Engineering, Ajou University (2023–2025)' },
                { label: 'Advisor', value: 'Dr. Jaehyun So' },
                { label: 'Location', value: 'Sejong, Republic of Korea' },
                { label: 'Contact', value: 'chiu.roh@gmail.com' },
              ].map(({ label, value }) => (
                <div key={label} className="flex flex-col gap-1 border-b border-white/[0.06] pb-4">
                  <p className="font-mono text-cream/30 text-xs tracking-[0.25em] uppercase">{label}</p>
                  <p className="font-mono text-cream/80 text-sm lg:text-base">{value}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div>
          ...
          <div className="liquid-glass rounded-2xl p-8 lg:p-12">
            <p className="font-condiment text-neon text-2xl sm:text-3xl mb-5 leading-none">
              Thesis
            </p>
            <h2 className="font-grotesk text-cream text-xl lg:text-3xl leading-tight mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div>
                ...
                <p className="font-mono text-cream/80 text-sm lg:text-base">
                  Master of Science<br />Transportation Engineering
                </p>
              </div>
              <div>
                <p className="font-mono text-cream/30 text-xs tracking-[0.2em] uppercase mb-2">Institution</p>
                <p className="font-mono text-cream/80 text-sm lg:text-base">Ajou University<br />Suwon, Korea</p>
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="liquid-glass rounded-2xl p-7">
              ...
              <p className="font-mono text-cream text-sm lg:text-base leading-relaxed">
                Application of Autonomous Driving Simulation Technology<br />
                (Practical Training — SUMO)
              </p>
              <p className="font-mono text-cream/40 text-sm mt-3">
                2024 ITS & Smart Mobility Summer School, Aug. 2024
              </p>
            </div>
            <div className="liquid-glass rounded-2xl p-7">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={course} className="flex items-start gap-3 font-mono text-sm lg:text-base">
              ...
              <div key={label} className="liquid-glass rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {items.map((item) => (
                    <span
                      key={item}
                      className="font-mono text-cream/70 text-sm border border-white/10 rounded-lg px-3 py-1.5"
                    >
                      {item}
                    </span>
                  ))}
